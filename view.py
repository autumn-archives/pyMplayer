    ...
    def make_window(self,theme='Dark Brown1'):
        ...
        layout = [
            ...
            [sg.Text('ファイル'), sg.InputText(key='-file1-', enable_events=True),
                sg.FileBrowse(key='-file1-',file_types=(('Media Files', '*.mp3',),
                    ('OGG Files', '*.ogg')))
            ],
